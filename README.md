...
1. **`04-documentation/BACKLOG_ROADMAP_FRAMEWORK_STANDARD_v1_10_0.md`** — the framework itself. §2 is
...
bash 03-tooling/backlog_gate_v1_1_6.sh          # full release gate
python3 03-tooling/backlog_validate_v1_2_0.py <your-register.ttl>
```
