#!/usr/bin/env python3
"""backlog_validate v1.2.0 — conformance validator for the Backlog & Roadmap
...
Usage:
  backlog_validate_v1_2_0.py DATA.ttl [DATA2.ttl ...]
  backlog_validate_v1_2_0.py --next DATA.ttl [--method IRI]
  backlog_validate_v1_2_0.py --gate-k
"""
