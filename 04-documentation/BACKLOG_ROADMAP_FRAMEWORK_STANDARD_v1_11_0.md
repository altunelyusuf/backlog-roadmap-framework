...
python3 03-tooling/backlog_roadmap_report_v1_2_0.py my_register.ttl --emit report.ttl

# 5. Run the four-gate release check (self-proving)
bash 03-tooling/backlog_gate_v1_1_6.sh my_register.ttl
```
...
`backlog_gate_v1_1_6.sh` runs Gate 0 (manifest self-verify), Gate P (every Turtle file parses),
