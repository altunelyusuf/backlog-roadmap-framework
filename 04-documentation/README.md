...
04-documentation/
  BACKLOG_ROADMAP_FRAMEWORK_STANDARD_v1_96_0.md the standard: concepts, levels, adoption
...
Read `04-documentation/BACKLOG_ROADMAP_FRAMEWORK_STANDARD_v1_96_0.md` first; section 4 is the
