...
03-tooling/
  ...
  backlog_gate_v1_1_21.sh                       four-gate release check (0/P/K/R) + coverage, self-proving
...
04-documentation/
  BACKLOG_ROADMAP_FRAMEWORK_STANDARD_v1_53_0.md the standard: concepts, levels, adoption
...
bash 03-tooling/backlog_gate_v1_1_21.sh                      # four gates + self-proof + coverage
bash 03-tooling/backlog_gate_v1_1_21.sh my_register.ttl      # ... plus a register
python3 03-tooling/backlog_roadmap_report_v1_5_0.py my_register.ttl
```

Read `04-documentation/BACKLOG_ROADMAP_FRAMEWORK_STANDARD_v1_53_0.md` first; section 4 is the
