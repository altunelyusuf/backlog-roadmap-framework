...
03-tooling/
  ...
  backlog_remote_commit_check_v1_0_0.py        whether a remote commit needs real reconciliation, decided by CrossProjectCommitAdvisoryShape against this package's own declared sovereign path -- not judged by hand each fetch
  ...
  backlog_gate_v1_1_27.sh                       four-gate release check (0/P/K/R) + coverage, self-proving
...
04-documentation/
  BACKLOG_ROADMAP_FRAMEWORK_STANDARD_v1_94_0.md the standard: concepts, levels, adoption
...
Read `04-documentation/BACKLOG_ROADMAP_FRAMEWORK_STANDARD_v1_94_0.md` first; section 4 is the
